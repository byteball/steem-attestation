...
exports.weHaveReferralProgram = (user_address) => {
	...
	return [
		...
		"➡ have new users copy-paste this to \"Chat > Add a new device > Accept invitation from the other device\" byteball:"+device.getMyDevicePubKey()+"@"+conf.hub+"#"+user_address+", which opens this attestation bot in the user's wallet, the wallet has to be already installed;\n" +
