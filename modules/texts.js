...
exports.weHaveReferralProgram = (user_address) => {
	...
	const qr_url = conf.site+"/qr.html?code="+ encodeURIComponent(invite_code);
	return [
		...
		"➡ have new users scan this code with wallet app "+qr_url+" , the wallet has to be already installed;\n" +
